"""
Django settings for SaaS NR Capital project.
...
SECRET_KEY = env('SECRET_KEY', default='lcqgfytXrzhaXBDXdLYJuFJZCVKHYXkQFPkiZijI')
...
ROOT_URLCONF = 'saas_nrcapital.urls'
...
WSGI_APPLICATION = 'saas_nrcapital.wsgi.application'
...
LANGUAGE_CODE = 'en-us'
LANGUAGE_COOKIE_NAME = 'saas_nrcapital_language'
LANGUAGES = [
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'SaaS NR Capital',
    'DESCRIPTION': 'Financial application for the evaluation of equity and bond exchange-traded funds (ETFs) and common stocks.',
    'VERSION': '0.1.0',
...
PROJECT_METADATA = {
    'NAME': gettext_lazy('SaaS NR Capital'),
    'URL': 'http://localhost:8000',
    'DESCRIPTION': gettext_lazy("Financial application for the evaluation of equity and bond exchange-traded funds (ETFs) and common stocks."),
    'IMAGE': 'https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg',
    'KEYWORDS': 'SaaS, django',
    'CONTACT_EMAIL': 'nathan.ramos.cfa@gmail.com',
}

USE_HTTPS_IN_ABSOLUTE_URLS = False  # set this to True in production to have URLs generated with https instead of http

ADMINS = [('Nathan Ramos', 'nathan.ramos.cfa@gmail.com')]
...
LOGGING = {
    ...
    'loggers': {
        ...
        'saas_nrcapital': {
            'handlers': ['console'],
            'level': env('SAAS_NRCAPITAL_LOG_LEVEL', default='INFO'),
        }
    }
}
